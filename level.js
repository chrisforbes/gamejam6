    ...
    this.tick = function() {
		...
		if ($('#success').is(':hidden')) {
        	...
        	if (win && containsWinnableActors) {
        	    // Time
        	    var t = this.remainingTicks / ticksPerSecond;
        	    var m = Math.floor(t / 60);
        	    var s = Math.ceil(t % 60);
        	    var points = 0;
        	    $('#score_time_raw').html(m+":"+((s <= 9) ?"0"+s : s));
        	    var score_time_points = Math.floor(t*250);
        	    points += score_time_points;
        	    $('#score_time_points').html(score_time_points);
        	    
        	    // Parts
        	    var score_parts_raw = 0;
        	    ...
        	    if (score_parts_raw > 0) {
        	        ...
        	        var score_parts_points = Math.floor(1000 * score_parts_raw);
        	        points += score_parts_points;
        	    ...
        	    if (this.destroyedObjects > 0) {
        	        ...
        	        var score_destruction_points = Math.floor(200 * this.destroyedObjects);
...
"new Map(15,10,\"[new Cell('wall03', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall05', undefined),new Cell('wall06', undefined),new Cell('floor', new LaserRear('laser-back','e')),new Cell('floor', new Laser('laser-blue','blue', 'e')),new Cell('caution4', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', new Mirror('mirror',sw')),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', new Fluff('fluff','3')),new Cell('tile', new Fluff('fluff','3')),new Cell('tile', new Fluff('fluff','6')),new Cell('wall06', undefined),new Cell('wall06', undefined),new Cell('floor', new LaserRear('laser-back','e')),new Cell('floor', new Laser('laser-red','red', 'e')),new Cell('caution4', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', new Mirror('mirror',sw')),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('wall06', undefined),new Cell('wall06', undefined),new Cell('floor', new LaserRear('laser-back','e')),new Cell('floor', new Laser('laser-green','green', 'e')),new Cell('caution4', undefined),new Cell('tile', undefined),new Cell('tile', new Mirror('mirror',sw')),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', new Fluff('fluff','4')),new Cell('tile', undefined),new Cell('tile', new Fluff('fluff','7')),new Cell('wall06', undefined),new Cell('wall10', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall05', undefined),new Cell('tile', undefined),new Cell('wall07', undefined),new Cell('tile', undefined),new Cell('wall07', undefined),new Cell('tile', undefined),new Cell('wall03', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall12', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('wall06', undefined),new Cell('tile', undefined),new Cell('wall06', undefined),new Cell('tile', undefined),new Cell('wall06', undefined),new Cell('tile', undefined),new Cell('wall06', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('wall06', undefined),new Cell('tile', undefined),new Cell('wall06', undefined),new Cell('tile', undefined),new Cell('wall06', undefined),new Cell('tile', undefined),new Cell('wall06', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('wall06', undefined),new Cell('tcaution1', undefined),new Cell('wall06', undefined),new Cell('tcaution1', undefined),new Cell('wall06', undefined),new Cell('tcaution1', undefined),new Cell('wall06', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('wall06', undefined),new Cell('tile', new Target('target-red','red', 'n')),new Cell('wall06', undefined),new Cell('tile', new Target('target-green','green', 'n')),new Cell('wall06', undefined),new Cell('tile', new Target('target-blue','blue', 'n')),new Cell('wall06', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('wall10', undefined),new Cell('wall09', undefined),new Cell('wall08', undefined),new Cell('wall09', undefined),new Cell('wall08', undefined),new Cell('wall09', undefined),new Cell('wall12', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined),new Cell('empty', undefined)]\", {'mirror' : 1}, 20)",
    "new Map(15,10,\"[new Cell('wall03', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall01', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall01', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall05', undefined),new Cell('wall06', undefined),new Cell('caution1', undefined),new Cell('caution1', undefined),new Cell('caution2', undefined),new Cell('floor', undefined),new Cell('wall14', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('wall14', undefined),new Cell('floor', undefined),new Cell('floor', new Fluff('fluff','6')),new Cell('caution0', undefined),new Cell('caution1', undefined),new Cell('wall06', undefined),new Cell('wall06', undefined),new Cell('floor', new LaserRear('laser-back','e')),new Cell('floor', new Laser('laser-red','red', 'e')),new Cell('caution4', undefined),new Cell('floor', undefined),new Cell('caution3', new Filter('filter-red','red', 'e')),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('caution3', new Filter('filter-blue','blue', 'e')),new Cell('floor', undefined),new Cell('floor', undefined),new Cell('caution3', undefined),new Cell('floor', new Target('target-blue','blue', 'w')),new Cell('wall06', undefined),new Cell('wall06', undefined),new Cell('caution1', undefined),new Cell('caution1', undefined),new Cell('caution7', undefined),new Cell('floor', undefined),new Cell('wall07', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('wall07', undefined),new Cell('floor', undefined),new Cell('floor', undefined),new Cell('caution5', undefined),new Cell('caution6', undefined),new Cell('wall06', undefined),new Cell('wall06', undefined),new Cell('floor', undefined),new Cell('floor', new Fluff('fluff','8')),new Cell('floor', undefined),new Cell('floor', new Fluff('fluff','7')),new Cell('wall06', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('wall06', undefined),new Cell('floor', new Fluff('fluff','7')),new Cell('floor', undefined),new Cell('floor', undefined),new Cell('floor', undefined),new Cell('wall06', undefined),new Cell('wall06', undefined),new Cell('floor', undefined),new Cell('floor', undefined),new Cell('floor', undefined),new Cell('floor', new Fluff('fluff','6')),new Cell('wall06', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('wall06', undefined),new Cell('floor', new Fluff('fluff','6')),new Cell('floor', undefined),new Cell('floor', undefined),new Cell('floor', undefined),new Cell('wall06', undefined),new Cell('wall06', undefined),new Cell('caution1', undefined),new Cell('caution1', undefined),new Cell('caution2', undefined),new Cell('floor', undefined),new Cell('wall14', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('wall14', undefined),new Cell('floor', undefined),new Cell('floor', undefined),new Cell('caution0', undefined),new Cell('caution1', undefined),new Cell('wall06', undefined),new Cell('wall06', undefined),new Cell('floor', new LaserRear('laser-back','e')),new Cell('floor', new Laser('laser-blue','blue', 'e')),new Cell('caution4', undefined),new Cell('floor', undefined),new Cell('caution3', new Filter('filter-blue','blue', 'e')),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('caution3', new Filter('filter-red','red', 'e')),new Cell('floor', undefined),new Cell('floor', undefined),new Cell('caution3', undefined),new Cell('floor', new Target('target-red','red', 'w')),new Cell('wall06', undefined),new Cell('wall06', undefined),new Cell('caution6', undefined),new Cell('caution6', undefined),new Cell('caution7', undefined),new Cell('floor', undefined),new Cell('wall07', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('tile', undefined),new Cell('wall07', undefined),new Cell('floor', undefined),new Cell('floor', new Fluff('fluff','8')),new Cell('caution5', undefined),new Cell('caution6', undefined),new Cell('wall06', undefined),new Cell('wall10', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall08', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall08', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall09', undefined),new Cell('wall12', undefined)]\", {'mirror' : 6, 'mirror-double' : 1}, 60)",
];
